...
async function PUT(req) {
    try {
        ...
        const { workspaceId, executionCosts } = body;
        if (!workspaceId || !executionCosts) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "Workspace ID and executionCosts are required"
            }, {
                status: 400
            });
        }
        const workspace = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$ExecutionWorkspace$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(workspaceId, {
            executionCosts
        }, {
            new: true,
            runValidators: true
        ...
        console.error("Update execution costs error:", error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: "Failed to update execution costs"
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0422061a._.js.map