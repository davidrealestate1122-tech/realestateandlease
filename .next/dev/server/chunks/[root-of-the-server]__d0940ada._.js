...
"[project]/realestateandlease/app/api/users/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    data.password = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(data.password, 10);
    data.createdBy = authUser.id;
    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create(data);
...
async function GET(req) {
    ...
    const users = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find().select("-password").populate("createdBy", "fullName email");
    return __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(users);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__d0940ada._.js.map