...
async function fetchFromPublicSource() {
    ...
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].request(options);
        ...
        const listings = apiResults.map((item, idx)=>{
            try {
                ...
                const listing = {
                    ...
                    soldDate: idx >= 1 ? new Date(Date.now() - (90 + Math.random() * 90) * 24 * 60 * 60 * 1000).toISOString().split("T")[0] : new Date(Date.now() - Math.random() * 15552000000).toISOString().split("T")[0],
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c055cb07._.js.map