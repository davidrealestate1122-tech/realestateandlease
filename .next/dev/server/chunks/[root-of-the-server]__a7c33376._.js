...
"[project]/realestateandlease/app/api/execution/costs/workspace/[workspaceId]/history/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, context) {
    try {
        ...
        const history = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$CostHistory$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            workspaceId
        }).sort({
            createdAt: -1
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(history, {
            status: 200
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a7c33376._.js.map