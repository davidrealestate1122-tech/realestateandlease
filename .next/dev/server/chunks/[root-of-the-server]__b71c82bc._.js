...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs)");
;
const DocumentSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema({
    templateId: {
...
async function POST(req) {
    try {
        ...
        // 👉 TEMP: just create dummy file
        const fileName = `doc-${Date.now()}.txt`;
        const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "public", "generated", fileName);
        __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].writeFileSync(filePath, "Generated Document");
        // 👉 version logic
        const count = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$Document$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
            templateId,
            propertyId
        });
        const doc = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$Document$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            templateId,
            propertyId,
            fileUrl: `/generated/${fileName}`,
            version: count + 1
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(doc);
    } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b71c82bc._.js.map