...
async function POST(req) {
    try {
        ...
        const uploadDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "public", "uploads", workspaceId);
        ...
        // Save metadata to your DB here
        // await FileModel.create({ fileName, fileUrl, fileType, workspaceId, propertyId, uploadedBy, ... })
        return __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            data: {
                fileName: file.name,
                fileUrl,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d48954ee._.js.map