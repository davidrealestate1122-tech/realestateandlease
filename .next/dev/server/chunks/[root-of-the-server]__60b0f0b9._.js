...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs)");
;
const DealDataSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema({
    propertyId: String,
    data: {
        type: Object,
        default: {}
...
"[project]/realestateandlease/app/api/deal-data/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$DealData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
        propertyId
    });
    if (existing) {
        existing.data = data;
        await existing.save();
        return __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(existing);
    }
    const newData = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$DealData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
        propertyId,
        data
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newData);
}
async function GET(req) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
    const propertyId = req.nextUrl.searchParams.get("propertyId");
    const data = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$DealData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
        propertyId
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(data || {});
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__60b0f0b9._.js.map