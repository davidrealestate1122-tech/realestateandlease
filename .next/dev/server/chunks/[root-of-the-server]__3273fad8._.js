...
"[project]/realestateandlease/lib/buildFinalData.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function buildFinalData(variables, sources) {
    const result = {};
    variables.forEach((v)=>{
        if (v.overrideValue) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$lib$2f$buildFinalData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/realestateandlease/lib/buildFinalData.ts [app-route] (ecmascript)");
...
async function GET(req, { params }) {
    ...
    const variables = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$Variable$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
        templateId: params.id
    });
    const dealData = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$DealData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
        propertyId
    });
    const final = (0, __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$lib$2f$buildFinalData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildFinalData"])(variables, {
        deal: dealData?.data || {}
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(final);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__3273fad8._.js.map