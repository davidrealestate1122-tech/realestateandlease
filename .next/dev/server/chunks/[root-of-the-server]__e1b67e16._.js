...
async function POST(req) {
    ...
    try {
        ...
        const ops = variables.filter((v)=>v.value !== undefined) // save all including empty (user cleared it)
        .map((v)=>__TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$DealData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
                templateId,
                propertyId,
                variable: v.variable
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e1b67e16._.js.map