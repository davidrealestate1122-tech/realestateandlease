...
var __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/realestateandlease/node_modules/bcryptjs/index.js [app-route] (ecmascript)");
...
async function GET(req, { params }) {
    try {
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id).select("-password");
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function PUT(req, { params }) {
    try {
        ...
        const currentUser = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id);
        if (!currentUser) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "User not found"
            }, {
        ...
        if (body.password && body.password.trim()) {
            body.password = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(body.password, 10);
        } else {
            delete body.password;
        }
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, body, {
            new: true
        }).select("-password");
        return __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            _id: user._id.toString(),
...
async function DELETE(req, { params }) {
    try {
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id);
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "User not found"
            }, {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d5cf38bc._.js.map