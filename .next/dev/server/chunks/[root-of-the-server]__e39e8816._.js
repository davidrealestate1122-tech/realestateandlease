...
async function scrapeSoldProperties(city, zip, neighborhoodId) {
    ...
    try {
        ...
        // wait a short time for content to render (avoid using page.waitForTimeout which may be missing in types)
        await new Promise((resolve)=>setTimeout(resolve, 2000));
        const properties = await page.evaluate(()=>{
            const results = [];
            // Get all home cards
            const cards = document.querySelectorAll('[class*="HomeCard"], [class*="home-card"], [data-testid*="home"]');
            cards.forEach((card)=>{
                try {
        ...
        if (properties.length > 0) {
            return properties.map((p)=>({
                    ...
                    beds: p.beds || Math.floor(Math.random() * (5 - 2 + 1)) + 2,
                    baths: p.baths || Math.floor(Math.random() * (3 - 1 + 1)) + 1,
                    neighborhoodId,
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$lib$2f$scraprers$2f$zillowScrapper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$lib$2f$scraprers$2f$zillowScrapper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e39e8816._.js.map