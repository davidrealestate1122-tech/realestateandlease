...
async function fetchPublicListings() {
    return [
        ...
        {
            externalId: "PUBLIC_1011",
            address: "640 Sunset Ave",
            city: "Arlington",
            state: "TX",
            zip: "76010",
            price: 310000,
        ...
        {
            externalId: "PUBLIC_1012",
            address: "777 Brookside Dr",
            city: "Arlington",
            state: "TX",
            zip: "76011",
            price: 420000,
...
// simple in-memory registry for demo
const lastSeenMap = new Map();
function detectChanges(listings) {
    return listings.filter((listing)=>{
        const lastSeen = lastSeenMap.get(listing.externalId);
        // New listing → evaluate
        if (!lastSeen) {
            lastSeenMap.set(listing.externalId, listing.updatedAt);
            return true;
        }
        // Changed listing → evaluate
        if (lastSeen !== listing.updatedAt) {
            lastSeenMap.set(listing.externalId, listing.updatedAt);
            return true;
        }
        // Unchanged → skip
...
"[project]/realestateandlease/lib/underwriting/underwritingEngine.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function runUnderwriting(listing) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$lib$2f$underwriting$2f$underwritingEngine$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/realestateandlease/lib/underwriting/underwritingEngine.ts [app-route] (ecmascript)");
;
function evaluateProperty(listing) {
    const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$lib$2f$underwriting$2f$underwritingEngine$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runUnderwriting"])(listing);
    return {
        ...
        underwriting: {
            ...
            baseArv: result.baseArv,
            adjustedArv: result.adjustedArv,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fbb27a46._.js.map