...
"[project]/realestateandlease/app/api/execution/properties/[propertyId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const [phase1, workspace] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$Phase1Snapshot$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
                propertyId
            }).lean(),
            __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$ExecutionWorkspace$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
                propertyId
            }).lean()
        ]);
        ...
        let checklist = [];
        if (workspace?._id) {
            checklist = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$DueDiligenceItem$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
        ...
        const responseData = {
            ...
            workspace: workspace ? {
                ...
                executionCosts: workspace.executionCosts || null,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(responseData, {
            status: 200,
            headers
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b17f696f._.js.map