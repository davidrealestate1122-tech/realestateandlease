...
async function POST(req) {
    ...
    try {
        ...
        await execAsync(`libreoffice --headless --convert-to pdf --outdir "${pdfDir}" "${absDocx}"`);
        ...
        // Save pdfUrl back to document record
        doc.pdfUrl = pdfUrl;
        doc.pdfPath = pdfPath;
        await doc.save();
        return __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2992731f._.js.map