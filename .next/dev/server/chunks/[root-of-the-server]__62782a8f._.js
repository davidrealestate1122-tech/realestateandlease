...
;
async function extractDocxVariables(filePath) {
    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$mammoth$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].extractRawText({
        path: filePath
    });
...
async function POST(req) {
    try {
        ...
        if (ext === "docx") {
            variables = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$lib$2f$extractDocx$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["extractDocxVariables"])(fullPath);
        } else if (ext === "xlsx") {
            console.log({
                message: "xlsx upload"
            });
        ...
        if (variables.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                warning: "No variables found. Use {{variable}} format in template.",
                template,
                variables: []
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__62782a8f._.js.map