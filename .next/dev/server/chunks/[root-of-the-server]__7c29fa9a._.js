...
"[project]/realestateandlease/app/api/execution/timeline/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(req, { params }) {
    try {
        ...
        const updatedTimeline = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$ExecutionTimeline$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, body, {
            new: true,
            runValidators: true
        });
        if (!updatedTimeline) {
...
async function DELETE(req, { params }) {
    try {
        ...
        const deletedTimeline = await __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$models$2f$ExecutionTimeline$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(id);
        if (!deletedTimeline) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "Timeline not found"
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7c29fa9a._.js.map