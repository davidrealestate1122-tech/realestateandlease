...
function DealDetailsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DealDetailsPage.useEffect": ()=>{
            fetch(`/api/deals/${id}`).then({
                "DealDetailsPage.useEffect": (res)=>res.json()
            }["DealDetailsPage.useEffect"]).then(setDeal);
        }
    }["DealDetailsPage.useEffect"], [
        id
    ]);
    if (!deal) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
        className: "p-8",
        children: "Loading…"
    }, void 0, false, {
...
_s(DealDetailsPage, "1JFFLIIaR93qlW26tbwSF/rskwo=", false, function() {
    return [
...
//# sourceMappingURL=realestateandlease_30b75e75._.js.map