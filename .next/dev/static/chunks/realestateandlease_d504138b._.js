...
"[project]/realestateandlease/app/daily-summary/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DailySummaryPage() {
    ...
    const [selectedDate, setSelectedDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(today);
    const summaryByDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DailySummaryPage.useMemo[summaryByDate]": ()=>{
            const passDeals = __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDeals"].filter({
                "DailySummaryPage.useMemo[summaryByDate].passDeals": (deal)=>deal.status === "PASS"
            }["DailySummaryPage.useMemo[summaryByDate].passDeals"]);
            const grouped = passDeals.reduce({
                "DailySummaryPage.useMemo[summaryByDate].grouped": (acc, deal)=>{
            ...
            }["DailySummaryPage.useMemo[summaryByDate].grouped"], {});
            return Object.entries(grouped).sort({
                "DailySummaryPage.useMemo[summaryByDate]": ([dateA], [dateB])=>dateB.localeCompare(dateA)
            }["DailySummaryPage.useMemo[summaryByDate]"]).map({
                "DailySummaryPage.useMemo[summaryByDate]": ([date, deals])=>({
                        date,
                        deals,
                        totalPrice: deals.reduce({
                            "DailySummaryPage.useMemo[summaryByDate]": (sum, d)=>sum + d.price
                        }["DailySummaryPage.useMemo[summaryByDate]"], 0),
                        totalARV: deals.reduce({
                            "DailySummaryPage.useMemo[summaryByDate]": (sum, d)=>sum + d.arv
                        }["DailySummaryPage.useMemo[summaryByDate]"], 0),
                        avgProfit: deals.reduce({
                            "DailySummaryPage.useMemo[summaryByDate]": (sum, d)=>sum + d.profitPercent
                        }["DailySummaryPage.useMemo[summaryByDate]"], 0) / deals.length
                    })
            }["DailySummaryPage.useMemo[summaryByDate]"]);
        }
    }["DailySummaryPage.useMemo[summaryByDate]"], []);
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                    children: selectedDaySummary.deals.map((deal)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$realestateandlease$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
...
_s(DailySummaryPage, "ClmggX/Pq79L8DCwq6Bim7oyKpM=");
_c = DailySummaryPage;
var _c;
__turbopack_context__.k.register(_c, "DailySummaryPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=realestateandlease_d504138b._.js.map